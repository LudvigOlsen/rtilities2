...
#'  non-alphanumeric characters with \code{\link[rtilities2:strip]{strip()}} and regenerates them.
#'
...
#'  (with \code{\link[rtilities2:strip]{strip()}}), we can avoid such failed tests.
