...
test_that("is_between() works",{
  ...
  expect_error(is_between(3, -3, NA),
               ...
               fixed = TRUE)
  expect_error(is_between(3, -3, 4, NULL), # Different in test suite and here. Does checkmate wrap lines?
