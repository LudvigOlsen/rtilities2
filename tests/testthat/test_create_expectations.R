...
test_that("expectation are created properly with create_expectations_vector()",{
  ...
  # Vec 1
  expect_equal(create_expectations_vector(vec_1),
               list("expect_equal(\n  vec_1,\n  c(1, 2, 3, 4),\n  tolerance = 1e-4)"))
  expect_equal(
    vec_1,
    c(1, 2, 3, 4),
  ...
  expect_equal(create_expectations_vector(vec_2),
               list("expect_equal(\n  vec_2[[\"a\"]],\n  10,\n  tolerance = 1e-4)",
                    "expect_equal(\n  vec_2[[\"b\"]],\n  20,\n  tolerance = 1e-4)",
                    "expect_equal(\n  vec_2[[\"c\"]],\n  30,\n  tolerance = 1e-4)",
                    "expect_equal(\n  names( vec_2 ),\n  c(\"a\", \"b\", \"c\"))"))
  ...
  expect_equal(create_expectations_vector(vec_3),
               exp_vec_3)
  ...
  expect_equal(create_expectations_vector(vec_4),
               exp_vec_4)
